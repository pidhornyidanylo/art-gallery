    ...
    >
      <div>
        ...
        <p className={paragraphStyles}>
          ...
          territorio Lodigiano all&apos;arte contemporanea. Aspiriamo a essere
          un catalizzatore per la sperimentazione, l&apos;apprendimento e la
        ...
        <p className={paragraphStyles}>viale Pavia 26 - Lodi, Italia - 26900</p>
      </div>
      <iframe
        ...
        style={{ width: '100%', minHeight: '343px', maxHeight: '1000px' }}
        className="flex-1"
        loading="lazy"
      ></iframe>
    </section>
