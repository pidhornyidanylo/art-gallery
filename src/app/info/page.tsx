...
const InfoPage = () => {
  return (
    <section className="pt-16" style={{ fontFamily: "Benne" }}>
      <h3 style={{ fontFamily: "Benne" }} className="text-4xl">Chi siamo</h3>
      <p
        className="text-2xl mt-4 mb-8 text-justify"
      ...
      >
        ...
        catalizzatore per la sperimentazione, l'apprendimento e la creatività,
        un luogo di ritrovo per tutti e una casa per gli artisti e le loro idee.
      </p>
      <h3 style={{ fontFamily: "Benne" }} className="text-4xl">Orari</h3>
      <p
        className="text-2xl mt-4 mb-8 text-justify"
        style={{ lineHeight: 1.4 }}
      >
      ...
      <h3 style={{ fontFamily: "Benne" }} className="text-4xl">Contatti generali</h3>
      <p
        className="text-2xl mt-4 mb-8 text-justify"
        style={{ lineHeight: 1.4 }}
      >
      ...
      <h3 style={{ fontFamily: "Benne" }} className="text-4xl">Indirizzo</h3>
      <p
        className="text-2xl mt-4 mb-8 text-justify"
        style={{ lineHeight: 1.4 }}
      >
